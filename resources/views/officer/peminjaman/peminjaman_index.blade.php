    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-start mb-3 gap-3">
                <a href="{{ route('ofc.export.peminjaman') }}" class="btn btn-sm btn btn-success"><i
                ...
                <tbody>
                    @forelse ($peminjaman as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('peminjaman-ofc.show', $item->id) }}" class="btn btn-sm btn btn-info">
                                    <i class="bi bi-eye"></i>
                                    Detail</a>
                                <a href="{{ route('peminjaman-ofc.edit', $item->id) }}" class="btn btn-sm btn btn-warning">
