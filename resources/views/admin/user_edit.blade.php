      ...
      <div class="card-body">
        <form method="POST" action="{{ route('user.update', $dataUser->id) }}">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" class="form-control" id="judul" placeholder="" value="{{ old('name', $dataUser->name) }}">
            </div>
            @error('name')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="email" name="email" class="form-control" id="penulis" placeholder="" value="{{ old('email', $dataUser->email) }}">
            </div>
            @error('email')
                <div class="alert alert-danger mt-2">
                     {{ $message }}
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="telepon" class="form-control" id="penerbit" placeholder="" value="{{ old('telepon', $dataUser->telepon) }}">
            </div>
            @error('telepon')
                <div class="alert alert-danger mt-2">
                     {{ $message }}
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="alamat" class="form-control" id="tahun" placeholder="" value="{{ old('alamat', $dataUser->alamat) }}">
            </div>
            @error('alamat')
                <div class="alert alert-danger mt-2">
                     {{ $message }}
