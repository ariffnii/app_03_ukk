...
@section('content')
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('ulasan.update', $buku->id) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="komentar" id="" cols="30" rows="5" class="form-control" placeholder="">{{ old('komentar', $ulasan->komentar) }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
